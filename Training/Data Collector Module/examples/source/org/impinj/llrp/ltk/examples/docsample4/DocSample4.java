package org.impinj.llrp.ltk.examples.docsample4;
...
public class DocSample4 implements LLRPEndpoint {
    ...
    private ADD_ROSPEC buildROSpecFromObjects() {
        ...
        ants.add(new UnsignedShort(3)); // 0 means all antennas
    ...
    private ADD_ROSPEC buildROSpecFromFile() {
        ...
        try {
            LLRPMessage addRospec = Util.loadXMLLLRPMessage(new File("./source/org/impinj/llrp/ltk/examples/docsample4/ADD_ROSPEC.xml"));
    ...
    private void setReaderConfiguration() {
        ...
        try {
            ...
            new File("./source/org/impinj/llrp/ltk/examples/docsample4/SET_READER_CONFIG.xml"));
