package org.impinj.llrp.ltk.examples.docsample1;
...
public class DocSample1 implements LLRPEndpoint {

	private LLRPConnection connection;

        private static Logger logger  = Logger.getLogger("org.impinj.llrp.ltk.examples.docsample1");
    ...
    private ADD_ROSPEC buildROSpecFromFile() {
        ...
        try {
            LLRPMessage addRospec = Util.loadXMLLLRPMessage(new File("./source/org/impinj/llrp/ltk/examples/docsample1/ADD_ROSPEC.xml"));
    ...
    public static void main(String[] args) {
        ...
        DocSample1 example = new DocSample1();
